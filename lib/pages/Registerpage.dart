...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void authenticatetheuser() async{
    ...
    if(mail=="" || pass=="" || rpass=="")
      ...
      {
        Fluttertoast.showToast(msg: "your password and retyped password is not matching");
        return;
      }
    else {
      try {
          var user=await _auth.createUserWithEmailAndPassword(email: mail, password: pass);
          if(user!=null)
